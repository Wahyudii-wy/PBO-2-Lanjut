...
class Dashboard:
    ...
    def menuAdmin(self):
        ...
        pengguna_menu.add_command(
            label='Data Petugas', command= lambda: self.new_window("Petugas", FrmPetugas)
        )
        buku_menu.add_command(
            label='Data Buku', command= lambda: self.new_window("Buku", FrmBuku)
        )
        peminjaman_menu.add_command(
            label='Data Peminjaman', command= lambda: self.new_window("Peminjaman", FrmPeminjaman)
        )
        peminjaman_menu.add_command(
            label='Data Pengembalian', command= lambda: self.new_window("Pengembalian", FrmPengembalian)
        )
        ...
        menubar.add_cascade(
            label="Data Penguna", menu=pengguna_menu
        )
        
        menubar.add_cascade(
            label="Data Buku", menu=buku_menu
        )
